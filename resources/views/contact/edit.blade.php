        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <br>
                    性別
                    <input type="radio" name="gender" value="0" id="" @if($contact->gender === 0) checked @endif>男性
                    <input type="radio" name="gender" value="1" id="" @if($contact->gender === 1) checked @endif>女性
                    <br>
                    年齢
                    <select name="age" id="">
